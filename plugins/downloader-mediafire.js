...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  if (!args[0]) throw `_*التنـزيلات ميديافايــر />*_\n\n*[ ℹ️ ] أدخل رابط ميديا فاير بعد الامر.*\n\n*[ 💡 ] مثــال:* _${usedPrefix + command} https://www.mediafire.com/file/r0lrc9ir5j3e2fs/DOOM_v13_UNCLONE_`;
  try {
