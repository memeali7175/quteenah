...
const handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    try {
        ...
        if (args[0] === null || args[0] === undefined) {
            ...
            const str = `*╔═ 🪐لعبـة المجـرة 🪐 ═╗*

 👨‍🚀 مرحبـا *${m.pushName}*,حان الوقت للسفر عبر الفضاء ، وكويكبات الألغام ، والدردشة مع الأصدقاء وأكثر من ذلك بكثير في عالم المجرة!

  *💰 العملـة:* ${data.perfil.carteira.currency}
