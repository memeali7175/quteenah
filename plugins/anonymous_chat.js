...
async function handler(m, {usedPrefix, command}) {
  ...
  switch (command) {
    ...
    case 'مغادرة': {
      ...
      if (!room) return this.sendMessage(other, {text: `${tradutor.texto1} ${usedPrefix}دردشة`}, {quoted: m});
      ...
      if (other) await this.sendMessage(other, {text: `${tradutor.texto3} ${usedPrefix}دردشة`}, {quoted: m});
    ...
    case 'دردشة': {
      if (Object.values(this.anonymous).find((room) => room.check(m.sender))) return this.sendMessage(m.chat, {text: `${tradutor.texto4} ${usedPrefix}مغادرة`}, {quoted: m});
      ...
      if (room) {
        ...
        room.b = m.sender;
        room.state = 'CHATTING';
        await this.sendMessage(m.chat, {text: `${tradutor.texto6} ${usedPrefix}تبديل`}, {quoted: m});
        ...
        await this.sendMessage(m.chat, {text: `${tradutor.texto7} ${usedPrefix}مغادرة`}, {quoted: m});
...
handler.command = ['دردشة', 'مغادرة', 'تبديل'];
