...
let handler = async (_0x10bd40, {
  ...
  if (!_0x27db11) {
    return _0x9c7141.reply(_0x10bd40.chat, "[❗] *مثال: .بينتريست افتارات صباح الخير*", _0x10bd40);
  }
  ...
  for (let _0x47c48a of _0x3b2637) {
    _0x51323f.push({
      ...
      'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
        'buttons': [{
          'name': "cta_url",
          'buttonParamsJson': "{\"display_text\":\"بينتريست 📫\",\"Url\":\"https://www.pinterest.com/search/pins/?rs=typed&q=" + _0x27db11 + "\",\"merchant_url\":\"https://www.pinterest.com/search/pins/?rs=typed&q=" + _0x27db11 + "\"}"
        }]
      })
    });
  }
      ...
      'message': {
        ...
        'interactiveMessage': proto.Message.InteractiveMessage.fromObject({
          'body': proto.Message.InteractiveMessage.Body.create({
            'text': "طلبـــــك : " + _0x27db11
          }),
          'footer': proto.Message.InteractiveMessage.Footer.create({
            'text': "🔎 `نتـائــج البــــحـــــــــــث`"
          }),
