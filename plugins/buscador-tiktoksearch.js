...
let handler = async (message, { conn, text }) => {
    if (!text) return conn.sendMessage(message.chat, { text: 'مثال: .تيكتوك يارب العالمين' }, { quoted: message });
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        body: proto.Message.InteractiveMessage.Body.create({ text: `*< نتائـج البحــث في تيك توك >*\n\n` + `📌 *طلبــك:* ${text}\n\n` + `📈 *النتــــائـــــــج:*` }),
...
handler.command = /^(تيكتوك|tiktoks)$/i;
