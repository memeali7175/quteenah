...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'إنظم لقناة البوت لتعرف بقية الميزات', body: null, thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaJWgziC6ZvfdIpx5922'}, mentionedJid: [m.sender]}}}, aa);
